...
## 🔄 In flight today (Wed afternoon)
- 🔄 **Speedrun Home ("The Run", revamp slice 1)** — Claude on `feat/speedrun-home`: H1 shared page ✅ (reviewed), H2 desktop shell ✅ (SpeedrunHome dialog + config-gated auto-open), H3 Android + AAR rebuild in progress. Cursor gate before merge.
