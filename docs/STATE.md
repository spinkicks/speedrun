...
## Per-repo `main` pins (updated 2026-07-02 PM, post-P0-merge)
- **anki `main` = `8ca3112d791966aa12378a9371dbacd3f83cd97d`** (`8ca3112d7`) — Phases 0–5 + all P0 honesty fixes (Memory decl-only, coverage=problems, mean-CI band, mini-mock reuse, no-fake-numbers UI) + Manrope/white identity.
- **anki-android `main` = `f2cf66ac35`** — P0 Android (real mini-mock + bridge parity).
- **Anki-Android-Backend** — re-pin at Phase 6 (rsdroid → anki `8ca3112d7`, AAR rebuild once).
- **`feat/speedrun-ai`** (umbrella worktree) — AI service, OFF by default, adversarially SAFE; consolidate to `main` at the end.
